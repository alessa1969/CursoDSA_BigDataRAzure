...
getwd()
setwd("C:/DSA/FCD/BigDataRAzure/CAP03")
getwd()
...
# TemperaturasGlobais.csv ~ 78 MB (zip) (unzip)
# Faça o download do arquivo zip no link abaizxo e descompacte na mesma pasta deste script
# https://drive.google.com/file/d/1nSwP3Y0V7gncbnG_DccNhrTRxmUNqMqa/view

# Instalando e Carregando Pacotes
# Obs: Os pacotes precisam ser instalados apenas uma vez. Se já instalou em outros scripts, não precisa repetir o procedimento abaixo
...
# Carregando os dados (Usando um timer para comparar o tempo de carregamento com diferentes)
